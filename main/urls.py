...
from main.views import show_main, create_products, show_products, show_xml, show_json, show_xml_by_id, show_json_by_id, add_product_entry_ajax, register, login_user, logout_user, edit_product, delete_product
